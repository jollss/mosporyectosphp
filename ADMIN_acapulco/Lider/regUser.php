        ...
        if($areaLider<>0){
            if(isset($_GET['dato'])){
                $dato=$_GET['dato'];
                    ...
                    */
                    $sql2="SELECT * FROM equipos_fielder inner join usuario inner join areas_fielder where '$areaLider'=id_area and idarea=id_area and id_fielder=idu and asignado='$iduser' and id_fielder=idu and (nombre like '%$dato%' OR apaterno like '%$dato%')
                    ";
                    //echo $sql2;
