...
$copes = array("CT CONSTITUCION","CT INDEPENDENCIA","CT VALLE DE BRAVO","CT SANTIAGO"
        ,"CT SANTA FE","CT CULHUACAN","CT AZORES","CT SAN ANTONIO ABAD","CT CUESTA","CT RENACIMIENTO","CT TEOTIHUACAN","CT SANTA MARTHA",
        "CT ZARAGOZA","CT COLINAS",
    );
//9 COPES
function cope_existe($existe,$copes_in,$copes_cmp,$foliopisa){
  ...
  if (strcmp($copes_in, "CT CONSTITUCION") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[0]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[1]){
  //}if($copes_in=="CT INDEPENDENCIA"){
  }if (strcmp($copes_in, "CT INDEPENDENCIA") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[1]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[2]){
  //}if($copes_in=="CT VALLE DE BRAVO"){
  }if (strcmp($copes_in, "CT VALLE DE BRAVO") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[2]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[3]){
  //}if($copes_in=="CT SANTIAGO"){
  }if (strcmp($copes_in, "CT SANTIAGO") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[3]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[4]){
  //}if($copes_in=="CT SANTA FE"){
  }if (strcmp($copes_in, "CT SANTA FE") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[4]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[5]){
  //}if($copes_in=="CT CULHUACAN"){
  }if (strcmp($copes_in, "CT CULHUACAN") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[5]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[6]){
  //}if($copes_in=="CT AZORES"){
  }if (strcmp($copes_in, "CT CONSTITUCION") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[6]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[7]){
  //}if($copes_in=="CT SAN ANTONIO ABAD"){
  }if (strcmp($copes_in, "CT ANTONIO ABAD") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[7]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in==$copes_cmp[8]){
  //}if($copes_in=="CT CUESTA"){
  }if (strcmp($copes_in, "CT CUESTA") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  //}if($copes_in=="CT RENACIMIENTO"){
  }if (strcmp($copes_in, "CT RENACIMIENTO") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }if (strcmp($copes_in, "CT TEOTIHUACAN") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }if (strcmp($copes_in, "CT SANTA MARTHA") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }if (strcmp($copes_in, "CT ZARAGOZA") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }if (strcmp($copes_in, "CT COLINAS") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }
  else{
