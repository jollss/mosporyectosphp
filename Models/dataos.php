...
//metodos
	...
	public function registroDataosBD($con){
          ...
          principal,secundario,claro_video,tipo_os,alfanumerico,serie,foto)
          VALUES
          ('".$this->iddataos."','".$this->supervisor_idu."','".$this->tecnico_asignado_idu."',
            ...
            '".$this->principal."','".$this->secundario."','".$this->claro_video."','".$this->tipo_os."','".$this->alfanumerico."','".$this->serie."','NO'
            )";
