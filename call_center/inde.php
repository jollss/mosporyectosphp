...
if ($result = $con->query("SELECT * FROM call_center WHERE estado_call=3 ORDER BY id_callc")) {
...
<div class="container col-md-12" name="toTop" id="topPos">
    ...
    <div align="center"><h3></h3></div>
        <div class="panel panel-info">
            ...
            <label>Pag.<?php echo $pagina;?></label>
            <nav aria-label="Page navigation">
              <ul class="pagination">
                ...
                <?php }; ?>
                 ...
                 <?php
                   $sql1="SELECT * FROM call_center WHERE estado_call=3 ORDER BY id_callc
                   LIMIT $empezar_desde, $cantidad_resultados_por_pagina";
                   $resultado=$con2->query($sql1);
                  ?>
                        <form action="infoos.php" method="POST">
                        <input type="text" value="<?php echo $pagina;?>" style="display:none;" name="pagina">
                            <div class="table-responsive" >
                                <table class="table table-bordered" style="background-color:white; font-size:10px !important;">
                                    <tr>
                                      <th><a href="inde.php">ID</a></th>
                                      <th><a href="indeConsecutivo.php">Consecutivo</a></th>
                                      <th><a href="indeCope.php">COPE</a></th>
                                      <th><a href="indeExpediente.php">EXPEDIENTE</a></th>
                                      <th>TELÉFONO</th>
                                      <th><a href="indeCliente.php">CLIENTE</a></th>
                                      <th><a href="indeDistrito.php">DISTRITO</a></th>
                                      <th><a href="indeSupervisor.php">SUPERVISOR</a></th>
                                      <th><a href="indeTecnico.php">TECNICO</a></th>
                                      <th><a href="indeEstatus.php">ESTATUS</a></th>
                                    </tr>
                                <?php
                                $aux=0;
                                $aux2=0;
