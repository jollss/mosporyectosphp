...
if ($result = $con->query("SELECT * FROM data_callcenter INNER JOIN call_center 
                    WHERE  estado_call=2 AND call_center_id_calc=id_callc ORDER BY id_cc")) {
                ...
                <?php 
                 ...
                 <?php
                   $sql1="SELECT * FROM data_callcenter INNER JOIN call_center 
                    WHERE  estado_call=2 AND call_center_id_calc=id_callc AND data_callcenter.call_center_id_calc=call_center.id_callc ORDER BY id_cc 
