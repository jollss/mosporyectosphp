                  ...
                  <div class="panel-body">
                    <input type="text" value="<?php echo $idmos;?>" style="display:none;" name="os">
                          ...
                          <div align="center">
                            ...
                            <label for="fileupload"> Subir imagen de OS</label>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="sel1" name="super">
                              <?php
                              $cons=Conectarse();
                              $cons->real_query("SELECT * FROM usuario WHERE tipo_idtipo=3 and activo=1");
                              $resultados = $cons->use_result();
                              while ($rows = $resultados->fetch_assoc()){
                                  $idus=$rows['idu'];
                                  $nombre=$rows['nombre'];
                                  $apaterno=$rows['apaterno'];
                                  $amaterno=$rows['amaterno'];
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="sel1" name="user">
                              ...
                              //$TOTAL=$Tecnico->TotalUsuariosActivosBD($con);
                              $cons=Conectarse();
                              $cons->real_query("SELECT * FROM usuario WHERE tipo_idtipo=1 and activo=1");
                              $resultados = $cons->use_result();
                              while ($rows = $resultados->fetch_assoc()){
                                  $idus=$rows['idu'];
                                  $nombre=$rows['nombre'];
