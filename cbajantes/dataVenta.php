                        ...
                        ?>
                            ...
                            if($statusV=='OBJETAR'){
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <input type="number" name="ident" value="<?php echo $idventa;?>" style="display:none;">
                                        ...
                                        <div class="input-group">
                                          <input type="text" class="form-control input-sm"  placeholder="Nombre Completo"  name="notelmex" required><br>
                                        </div>
                            ...
                            <div class="panel panel-info">
                                <?php
                                    ...
                                    if(!isset($fventa)){$observacion='';$p_telmex='';$fecha_v='';}else{
                                    $observacion=$fventa->regresaObservaciones();
                                    $p_telmex=$fventa->regresaPersonalTelmex();
                                    $fecha_v=$fventa->regresaFecha();
                                    }
                                    echo "Observaciones: ".$observacion."<br>";
                                    echo "Personal de Telmex: ".$p_telmex."<br>";
                                    echo "Fecha: ".$fecha_v."<br>";
                                ?>
                            </div>
                        </div>
                        <div class="col-md-6">
