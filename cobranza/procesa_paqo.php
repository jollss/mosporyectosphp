...
function validarse($folio_pisav){
    $con2 = Conectarse();
...
if(isset($_POST['paqo']) and isset($_POST['tipo_paqo'])){
    ...
    if($a1==0){
    	...
    	$sql11="UPDATE validar_os SET paqo='$paqo', tipo_paqo='$tipo_paqo' WHERE id_folio_pisa='".$folio_pisav."'";
    	echo $sql11."<br>";
$result = $con->query($sql11);
           echo "Actualizado el paqo";
