        ...
        <div class="col-md-12">
            <div align="center">
                ...
                <div class="panel panel-info">
                    ...
                    $aaaa=date('Y');
                    $semana = date("W");
                    if(!isset($_GET['tipoGet']) or $_GET['tipoGet']==''){ $tipoGet=23;}else{ $tipoGet=$_GET['tipoGet'];}
                    ...
                    <form action="promoverF.php" method="GET">
                        <select name="tipoGet" class="form-control">
                            ...
                            <option value="4">VALIDACION</option>
                        </select>
                                        ...
                                        <tr>
                                         ...
                                         <?php
                                            ...
                                            for ($i=0; $i < $totalU; $i++) { 
                                                ...
                                                //if($tipo==21 or $tipo==4 or $tipo==23 or $tipo==22 or $tipo==27 or $tipo==24){
                                                if($activoU==1){
                                                    if($tipo==$tipoGet){
                                                        $Venta=new Usuario();
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--
                                                            <form action="promoverF.php" method="GET">
                                                            <input type="text" name="tipoGet" value="<?php echo $tipoGet;?>">
