...
/*---------*/
        ...
        $asigna->existencia($idu,$idus,$con);
/*--------*/        
            ...
            <form action="regUserN.php" method="GET">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <input type="text" class="form-control" placeholder="Correo"  name="correo" aria-describedby="sizing-addon2" required>
                        coloca primer nombre punto [.] primer apellido y @mosproyectos.com.mx
                        </td>
                        ...
                        <td>
                            ...
                            while($row = $resultado->fetch_assoc())
                            {
                              $idtipo=$row['idtipo'];
                              $ntipo=$row['tipo'];
                            //  if($idtipo==32 or $idtipo==24 or $idtipo==27 or $idtipo==21 or $idtipo==20 or $idtipo==4){
                            if($idtipo==21){
                              ?>
