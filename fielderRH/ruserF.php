        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tipo">
                            ...
                            for ($i=0; $i <$tipos; $i++) { 
                              ...
                              if($i==4 or $i==21 or $i==24 or $i==32 or $i==40){
                                ?>
                    ...
                    <div class="input-group">
                      ...
                      <input type="email" class="form-control" placeholder="Correo"  value="PRIMERNOMBRE.PRIMERAPELLIDO@mosproyectos.com.mx" name="correo" aria-describedby="sizing-addon2" required>
                    </div>
                    <div class="input-group">
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Contraseña Temporal" name="pssw" value="123" aria-describedby="sizing-addon2" readonly>
            ...
            <div class="well well-sm"></div>
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="salario" min="0" step="0.01" aria-label="Amount (to the nearest dollar)">
