...
<section class="row">
    ...
    <form action="equiposF.php" method="GET">
            ...
            <td>
                <button type="button" class="btn btn-danger btn-md bntmodal myBtn" name="quitar_area" data-id="1" value="1" title="QUITAR EQUIPOS">-</button>
            </td>
        </tr>
    </table>
</section>
<section>
    <div class="col-md-12" style="height:500px;overflow-y:scroll;">
        ...
        <?php
            $sql="SELECT * FROM usuario inner join equipos_fielder inner join areas_fielder where id_fielder=idu and idarea=id_area and activo=1 order by id_area";
...
$(document).ready(function(){
    $('.bntmodal').click (function(){
        ...
        console.log(iduser);
        $('.modal-body').load('delEquipo.php?value='+iduser,function(){
