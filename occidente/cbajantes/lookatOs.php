...
if ($existencia==0) {
	...
	?>
	<div align="center">
		<form action="quitarAsig.php" method="POST">
			<input type="text" value="<?php echo $idmos;?>" style="display:none;" name="idmos" required>
			<input type="submit" value="QUITAR ASIGNACION" class="btn btn-danger" onclick="return confirm('Quitaras la asignacion, verifica que no sea una orden trabajada.\n ESTAS SEGURO?')">
		</form>
					...
					<tr>
						...
						<td>
							<form action="liberar.php" method="POST">
								<input type="text" value="<?php echo $idmos;?>" name="idmos" style="display:none;" readonly>
								<input type="submit" class="btn btn-primary" value="LIBERAR">
							</form>
						</td>
					</tr>
				</table>
