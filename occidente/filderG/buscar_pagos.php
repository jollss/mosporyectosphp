...
<!--==============================================================================================================================================-->        
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><input type="number" min=2017 name="yi" placeholder="AÑO" required></td>
                <td></td>
                <td><input type="number" min=1 max=31 name="df" placeholdeR="DIA" required></td>
                <td>
                ...
                <td><input type="number" min=2017 name="yf" placeholder="AÑO" required></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
