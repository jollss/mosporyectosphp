        ...
        <div class="panel panel-info">
            ...
            <form class="form-horizontal" action=" moduser.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9">
                        <input type="text" class="form-control" id="inputApaterno"  name="ap" value="<?php echo $ap;?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">Apellido Materno: </label>
                    <div class="col-xs-9">
                        <input type="text" class="form-control" id="inputMaterno"  name="am" value="<?php echo $am;?>" readonly>
                    </div>
                </div>
                <!--
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9">
                       <input type="text" class="form-control" name="celular" value="<?php echo $cel;?>" aria-describedby="sizing-addon2" readonly>
                    </div>
                    <label class="control-label col-xs-3">Teléfono:</label>
                     <div class="col-xs-9">
                        <input type="text" class="form-control" name="telefono" value="<?php echo $tel;?>" aria-describedby="sizing-addon2" readonly>
                    </div>
                    <label class="control-label col-xs-3">Dirección:</label>
                     <div class="col-xs-9">
                        <input type="text" class="form-control" name="dir" value="<?php echo $dir;?>" aria-describedby="sizing-addon2" readonly>
                     </div>
                </div>
                <!--
                <div class="form-group">
