...
function pagoOnChange(sel) {
      if (sel.value=="PORTABILIDAD"){
           divT = document.getElementById("nAlta");
           divT.style.display = "none";
           divT = document.getElementById("nTargeta");
           divT.style.display = "none";
           divT = document.getElementById("nDish");
           divT.style.display = "none";

           divC = document.getElementById("nPortabilidad");
           divC.style.display = "";
      }
      if (sel.value=="ALTA"){
        
           divT = document.getElementById("nPortabilidad");
           divT.style.display = "none";
           divT = document.getElementById("nDish");
           divT.style.display = "none";
           divT = document.getElementById("nTargeta");
           ...
           divC = document.getElementById("nAlta");
           divC.style.display = "";
      }
      if (sel.value=="DISH"){
           divT = document.getElementById("nTargeta");
           ...
           divC = document.getElementById("nDish");
           divC.style.display = "";
      }
}
</script>
        ...
        <!--
            ...
            <!--</div>-->
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" pattern=".{7,}"  maxlength="7" placeholder="FOLIO"  name="folio" title="Folio de 7 digitos" aria-describedby="sizing-addon2" required>
                    </div>
                    <div class="input-group">
                  ...
                  <div class="well well">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="sel1" NAME="pago" onChange="pagoOnChange(this)">
                        <option value="SELECCIONA">SELECCIONA</option>
                        <option value="PORTABILIDAD">PORTABILIDAD</option>
                        <option value="ALTA">ALTA</option>
                        <option value="DISH">DISH</option>
                      </select>
                        <div id="nPortabilidad" style="display:none;">
                          <?php
                          echo "PORTABILIDAD";
                          ?>
                        </div>
                        <div id="nAlta" style="display:none;">
                          <?php
                          echo "ALTA";
                          ?>
                        </div>
                        <div id="nDish" style="display:none;">
                          <?php
                          echo "DISH";
                          ?>
                        </div>
                        <div id="nTargeta" style="display:;">
                          <?php
                           echo "Seleccióna un tipo";
                          ?>
                        </div>
                    </div>
                    <div class="input-group">
                      <span class="input-group-addon" id="sizing-addon2">Terminal:</span>
                      <input type="text" class="form-control" placeholder="Terminal"  name="terminal" aria-describedby="sizing-addon2">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-info">
            ...
            <div class="well well-sm"></div>
              <div class="form-group">
                    ...
                    <textarea class="form-control" rows="7" name="detalles" maxlength="800" placeholder="Detalles" style="resize:none;"></textarea>
                </div>
            <div class="">
                <div class="form-group">
