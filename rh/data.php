...
$Datauser->obtenerInfuserUBD($iduser,$con);
  ...
  $checador=$Datauser->regresaChecador();
...
<div class="container col-md-12" name="toTop" id="topPos">
    ...
    ?>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo $rfc?>" name="rfc" aria-describedby="sizing-addon2" >
                </div>
                -->
                <div class="input-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-addon" id="sizing-addon2">Checador: </span>
                  <input type="float" class="form-control" value="<?php echo $checador?>" name="checador" aria-describedby="sizing-addon2" required>
                </div>
            <div class="well well-sm"></div>
                <div class="input-group">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="salario" value="<?php echo $salario?>" step="0.01"  aria-label="Amount (to the nearest dollar)">
