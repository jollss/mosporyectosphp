...
foreach ($_POST['array_selecion'] as $valor) {  
    ...
    while($row = $resultado->fetch_assoc())
    {
		...
		/**************/
			...
			$pdf->Cell(190,8,"(".$bueno_l.") ",1,1,'C');
			$pdf->Cell(115,8,"correspondiente al pago de VACACIONES Y PRIMA VACACIONAL del periodo comprendido de ".$del." a ".$final.";",0,1,'L');
			$pdf->Cell(190,8," de conformidad con el articulo 76, 80 y 81 de la Ley Federal del Trabajo, cantidad que recibo a mi entera ",0,1,'L');
			$pdf->Cell(190,8,utf8_decode("satisfacción y firmo al calce para constancia."),0,1,'L');
			$pdf->Cell(190,10,"",0,1,'L');
			$pdf->Cell(20,8,"",0,0,'L');
