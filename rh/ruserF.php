        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Contraseña Temporal" value="123" aria-describedby="sizing-addon2" readonly>
            ...
            <div class="well well-sm">
                <span class="input-group-addon" id="sizing-addon2">Tipo de pago: </span>
