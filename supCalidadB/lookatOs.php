...
if ($existencia==0) {
	...
	?>
	<div align="center">
		<form action="dataosTec.php" method="POST">
			<input type="text" value="<?php echo $idmos;?>" style="display:none;" name="idmos" required>
			<input type="text" value="<?php echo $tecnicoAsig;?>" style="display:none;" name="tecnico" required>
			<input type="submit" value="VER" class="btn btn-success" onclick="return confirm('DA CLICK PARA CONTINUAR')">
		</form>
	</div>
	<div class="panel panel-info">
	    ...
	    <div class="panel-body" style="background-color:white;">
			...
			<div class="table-responsive">-->
				<table class="table">
					...
					<tr><td>Orden:<a href="../os/<?php echo $archivoOs;?>" target="_blank"><img src="../syspic/see.png" width="30" height="30"></td></tr>
				</table>
