            ...
            <div class="panel-body" style="background-color:gray;">
              <div class="col-md-4">
                ...
                <div class="panel panel-success">
                    <div class="page-header">
                      Teléfono <label>
                      <input type="tel" class="form-control" placeholder="Teléfono"  pattern=".{10}" name="tel" aria-describedby="sizing-addon2" title="Recuerda, se te solicita un teléfono." >
              ...
              <div class="col-md-4">
                <div class="panel panel-success">
                    <div class="page-header">
                      TIPO TAREA (A9-D2-TE-TS-FC-TI-TV-PQ2)
                      <label>
              ...
              <div class="panel panel-success">
                  <div class="panel-body">
                    <input type="text" value="<?php echo $idmos;?>"  name="os">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="sel1" name="user">
                              ...
                              for ($i=0; $i <= $TOTAL; $i++) {
                                ...
                                if($asignadoU==$iduser and $activo==1){
