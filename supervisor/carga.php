...
$copes = array("CT CONSTITUCION","CT INDEPENDENCIA","CT VALLE DE BRAVO",
                "CT SANTIAGO","CT SANTA FE","CT CULHUACAN",
                "CT AZORES","CT SAN ANTONIO ABAD","CT CUESTA",
                "CT RENACIMIENTO","CT TEOTIHUACAN","CT SANTA MARTHA",
                "CT ZARAGOZA","CT COLINAS","CT REYES","CT NAUCALPAN","CT VILLA DE LAS FLORES","CT COLINA","CT CHIMALHUACAN","CT OJO DE AGUA",);
//9 COPES
function cope_existe($existe,$copes_in,$copes_cmp,$foliopisa){
  ...
  if (strcmp($copes_in, "CT REYES") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }
  if (strcmp($copes_in, "CT NAUCALPAN") === 0){
    //echo $foliopisa."-".$existe."---".$copes_cmp[8]."=".$copes_in."-SI<br>";
    return 1;
  }
  ////////////////////////////////////////////////////////////////////
if (strcmp($copes_in, "CT VILLA DE LAS FLORES") === 0){
    return 1;
  }
  ///////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////
if (strcmp($copes_in, "CT COLINA") === 0){
    return 1;
  }
  ///////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////
if (strcmp($copes_in, "CT OJO DE AGUA") === 0){
    return 1;
  }
  ///////////////////////////////////////////////////////////////////
  else{
