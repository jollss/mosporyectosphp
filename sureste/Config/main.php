          ...
          <?php
                        if(isset($_SESSION['AltaGerencia'])){
                          ...
                          <button type="button" class="btn btn-primary ">
                            <span class="glyphicon glyphicon-king" aria-hidden="true"></span>SUR
                          </button>
                          </a></li>
                          <?php
                        }
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <?php
            if(isset($_SESSION['AltaGerencia'])){
              ...
              <li><a href="../AltaGerencia/bajantes.php">
              <button type="button" class="btn btn-primary ">
                <span class="glyphicon glyphicon-king" aria-hidden="true"></span>OCCIDENTE
              </button>
              </a></li>
              <?php
            }
           ...
           <!--<li><a href="seeos.php">BUSCAR OS</a></li>-->
            <li class="dropdown" >
              ...
              <ul class="dropdown-menu">
                ...
                <li role="separator" class="divider"></li>
                <li style="font-size:10px;">
                  <a href="../../bajantesG/inde.php">Regresar</a>
                </li>
              </ul>
            </li>
          </ul>
