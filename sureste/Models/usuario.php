...
//Metodos
	...
	public function registrarUsuarioBD($con){
	    ...
	    estatura,licencia,curp,tel_emerg,checador,tipo_personal,asignado,tipo_idtipo)
	    VALUES
	    ('".$this->idu."','3','".$this->activo."','".$this->correo."',
	     '".$this->nombre."','".$this->apaterno."','".$this->amaterno."','202cb962ac59075b964b07152d234b70',
	     ...
	     '".$this->tipo_personal."','".$this->asignado."','".$this->tipo_idtipo."'
	     )";
