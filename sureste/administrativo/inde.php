...
if($tipo_user==41){
    ...
    $place="CT UAX";
    $sql="SELECT * FROM os 
        WHERE folio_pisa='$dato' AND cope='$place' OR telefono='$dato' OR idmos='$dato' ORDER BY idmos DESC";
}if($tipo_user==40){
    //VILLA HERMOSA
    $place="CT VLL";
    $sql="SELECT * FROM os 
    ...
    $place2="CT MOJ";
    $sql="SELECT * FROM os 
        WHERE folio_pisa='$dato' AND cope='$place' OR cope='$place2' OR telefono='$dato' OR idmos='$dato' ORDER BY idmos DESC";
}
//echo "Hola soy: ".$sql."<br>".$place;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="col-md-12">
    ...
    <div class="panel panel-default col-md-6">
        <div class="panel-heading">Busqueda en <?php echo $place;?></div>
    ...
    if(isset($_GET['dato']) AND $dato<>''){
        ...
        while($row = $resultado->fetch_assoc())
        {
            ...
            {
                //$supervisor_idu=$rown['usuario_idu'];
...
<!--NOMBRE DEL TECNICO-->                
                <div class="col-md-12 table-responsive" style="background-color:white;border:solid;">
                    ...
                    <br><br>
                    <?php
                    if(isset($supervisor_idu) ){//or isset($supervisor_idu)){
                        ?>
...
<!--DATOS DE VALIDACION-->   
            ...
            if(isset($_GET['dato']) and isset($_GET['lol']) and $_GET['lol']==0){
                ...
                $sql="UPDATE validar_os SET fecha_coordinador='$fecha_super' WHERE id_folio_pisa='".$folio_p."'";
            ...
            if(!isset($id_f) or $fecha_calidad==''){
                echo "<h3>Imagenes sin validar por supervisor ni por calidad</h3>";
                /*
            ...
            if(isset($id_f) and $fecha_coordinador==''){
                ?>
                <td>
                <table border="2">
                    <tr>
            ...
            ?>
                <table>
                    ...
                    <!--
                        <td>
                        <?php
                        $sql31="SELECT * FROM validar_os WHERE id_folio_pisa='$folio_pisa'";
                        $resultado1=$con3->query($sql31);
                        while($row1 = $resultado1->fetch_assoc())
                        {
                            $cobro=$row1['a_cobro'];
                            $f_cobranza=$row1['fecha_cobranza'];
                        }
                        // echo $cobro." ".$f_cobranza;
                        if($cobro==0 and $f_cobranza=='' or !isset($cobro)){
                            ?>
                            ...
                            <?php
                        }if($cobro==1 and $f_cobranza<>''){
                            echo "Folio PAGADO (SIN OPCION DE EDICION)";
                        }
                        ?>
