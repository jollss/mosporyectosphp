...
?>
    <form action="asigMaterial.php" method="GET">
    ...
    ?>
        ...
        <table border="0" width="100%">
            <!--<tr><td>Ordenes Pendientes por Trabajar: <?php echo $ttl1;?><h3><?php echo "COBRE:".$aux." FIBRA:".$cobrea; ?></h3></td></tr>-->
            ...
            <!--<tr><td>Ordenes Liquidadas: <h3><?php echo $aux1; ?></h3></td></tr>-->
            <tr style=" border-bottom:1pt solid black;">    
