              ...
              <div class="col-md-4">
                <div class="panel panel-info"> 
                    <div class="page-header">
                      ...
                      FOLIO DE OS <label><input type="number" value="" name="foliopisa" maxlength="8" minlength="7" min=1000000 required><?php //echo $folio_pisa;?></label></br>
                ...
                <div class="panel panel-success">
                    <div class="page-header">
                      ...
                      Cliente <label><input type="text" value="" name="cliente" required><?php //echo $cliente;?></label>
              ...
              <div class="col-md-4">
                <div class="panel panel-success">
                    <div class="page-header">
                      ...
                      <label>
                      <input type="text" name="tipo_tarea" class="form-control" placeholder="TIPO DE TAREA">
