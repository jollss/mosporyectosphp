                        ...
                        <form name="formu" id="formu" action="upload.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="" style="height:180px;overflow-y:scroll;">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>ANTES</td>
                                        <td>1. Exterior  <input type="file" name="userfile[]" /></td>
                                        <td>2. Cableado Interior <input type="file" name="userfile[]" /></td>
                                        <td>3. DIT <input type="file" name="userfile[]" /></td>
                                        <td>4. Rosetas <input type="file" name="userfile[]" /></td>
                                    </tr>
                                    <tr>
                                        <td>DESPUES</td>
                                        <td>1. Exterior  <input type="file" name="userfile[]" /></td>
