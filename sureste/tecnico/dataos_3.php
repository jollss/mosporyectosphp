                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <select name="fibra"  class="form-control" required>
                                                                            <option value="0">0</option>
                                                            ...
                                                            <table class="table">
                                                                <tr>
                                                                    <td>
                                                                    <!--<input type="number" name="m_cobre" value="0" class="form-control" min=0 max=1000></td>-->
                                                                    <select name="m_cobre"  class="form-control" required>
                                                                        <option value="0">0</option>
                                                                        <option value="25">25</option>
                                                                        <option value="50">50</option>
                                                                        <option value="75">75</option>
                                                            ...
                                                            <table class="table">
                                                                <tr>
                                                                    <td>
                                                                    <!--<input type="number" name="m_cobre" value="0" class="form-control" min=0 max=1000>-->
                                                                    <select name="m_cobre"  class="form-control" required>
                                                                        <option value="0">0</option>
                                                                        <option value="25">25</option>
                                                                        <option value="50">50</option>
                        ...
                        <div class="" style="height:180px;overflow-y:scroll;">
                            ...
                            <table>
                                ...
                                <tr> 
                                    ...
                                    <td>6. Medidor de Potencia <input type="file" name="userfile[]" /></td>
                                </tr>
                                <tr>
                            ...
                            <!--<p>2. Terminal/Secundario</p>
                            <p>3. Instalación Exterior</p>
                            <p>4. Roseta</p>
                            <p>5. Instalación Interior</p>
                            <p>6. Modem</p>-->
