...
<br>
            ...
            <div align="center">
              ...
              <h3>Formulario de Orden de Servicio</h3>
            ...
            <table class="table table-bordered">
              ...
              //  $mes=date("d");
              $mes=date("d");
                $sql11= "SELECT dat.estatus,o.ddcarga,o.mmcarga,o.yearcarga,dat.foto,o.idmos,cope,expediente,folio_pisaplex,folio_pisa,telefono,distrito,zona,tipo_tarea
                FROM os  AS o INNER JOIN dataos AS dat ON o.idmos=dat.id_orden
                WHERE  O.ddcarga='$mes'  AND o.asignado='$idus' ";
                $result111 = $con->query($sql11);
                
                while($fila1 = $result111->fetch_array())
                {
$estatus = $fila1['estatus'] ;
                    $fotoq = $fila1['foto'] ;
                  $idmos=$fila1['idmos'];
                    $cope=$fila1['cope'];
                          ...
                          $folio_pisa=$fila1['folio_pisa'];
                            $telefono=$fila1['telefono'];
                              $distrito=$fila1['distrito'];
                                ...
                                $zona=$fila1['zona'];
                  if($fotoq=='NO' && $estatus==0){
                    echo "  <tr>
                      <th><center>AUN NO TIENE FOTO</center></th>
                <th>$idmos</th>
                <th>$cope</th>
                <th>$telefono</th>
                ...
                <th>$tipo_tarea</th>
                     ...
                     if($fotoq=='SI' && $estatus==1)
                     {
                       echo "  <tr>
                         <th><center>Esta Orden Esta ya objetada y Terminada</center></th>
                   <th>$idmos</th>
                   <th>$cope</th>
                   <th>$telefono</th>
                   <th>$ddcarga/$mmcarga/$yearcarga</th>
                  ...
                  echo"
                          <tr>
                          <th><center><a href='editarfotosos.php?id=$idmos'><i class='<i fas fa-edit fa-2x'></i></a></center></th>
                    <th>$idmos</th>
                    <th>$cope</th>
                    <th>$telefono</th>
                    <th>$ddcarga/$mmcarga/$yearcarga</th>
