            ...
            <div class="col-md-12">
                ...
                <form action="modDetalles.php" method="POST"  name="formulario">
                    <div class="col-md-12" align="center">
                            ...
                            <select name="delarea" class="form-control">
                                <option value="SI"> SI</option>
                                <option value="NO" >NO</option>
                            </select>
                    </div>
                    ...
                    <span class="input-group-addon" id="sizing-addon3">
                        ...
                        <?php 
                            ...
                            if($contesto=='NO'){
                                ...
                                <?php
                            }if($contesto<>'SI' AND $contesto<>'NO'){
                                ?>
                                <select name="contesto">
                                    <option value="NO">NO</option>
                                    <option value="SI">SI</option>
                ...
                <!--
                    ...
                    //if($siac<>0 or $siac<>''){ 
                            ...
                            <form action="modTienda.php" method="POST">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <input class="form-control" aria-describedby="sizing-addon4"  name="siac" type="text" value="<?php echo $siac;?>" required> 
                                    </tr>
                                    <tr>
                                ...
                                <?php
                                    ...
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-addon" id="sizing-addon3">Folio Siac:</span>
                                        <input class="form-control" aria-describedby="sizing-addon4"  name="siac"  type="text"  required> 
                                    </div>
                                    <?php
                                }
                                ?>
                        ...
                        <?php
                            ...
                            <form action="modTienda.php" method="POST">
                                <input type="hidden" name="id" value="<?php echo $idventa;?>" >
                                <input class="form-control" aria-describedby="sizing-addon4"  name="siac" type="hidden" value="<?php echo $siac;?>" required> 
                                <!--<div class="input-group input-group-sm">
