...
<div class="col-md-12">
        <div class="panel panel-info">
            ...
            <div class="col-md-12">
                ...
                <input type="" name="idventa" value="<?php echo $idventa;?>" style="display:none;">
                    <div class="well col-md-12">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input class="form-control" aria-describedby="sizing-addon4" value="<?php echo $nombre;?>" name="nombre"  >
                        </div>
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon" id="sizing-addon3">Apellido Paterno: <?php// echo $nombre;?></span>
                            <input class="form-control" aria-describedby="sizing-addon4" value="<?php echo $ap;?>" name="apaterno"  >
                        </div>
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon" id="sizing-addon3">Apellido Materno: <?php// echo $nombre;?></span>
                            <input class="form-control" aria-describedby="sizing-addon4" value="<?php echo $am;?>" name="amaterno"  >
                        </div>
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon" id="sizing-addon3">Dirección: <?php //echo $direccion;?></span>
                            <input class="form-control" aria-describedby="sizing-addon4" value="<?php echo $direccion;?>" name="dir"  >
                        </div>
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon" id="sizing-addon3">Detalles: <?php //echo $datos;?></span>
                            <input class="form-control" aria-describedby="sizing-addon4" value="<?php echo $datos;?>" name="datos"  >
                        </div>
                        <div class="input-group input-group-sm">
	            ...
	            <div class="col-md-12">
	            	...
	            	<div class="col-md-6">
	            		<!--=========-->
						<input type="hidden" name="siac" value="<?php echo $siac;?>">
	                    ...
	                    <div class="input-group input-group-sm">
	                        ...
	                        <input class="form-control" aria-describedby="sizing-addon4"  name="tienda"  value="<?php echo $comercial;?>" >
	                    </div>
	                    <div class="input-group input-group-sm">
	                        <span class="input-group-addon" id="sizing-addon3">Teléfono: </span>
	                        <input class="form-control" aria-describedby="sizing-addon4" type="tel" value="<?php echo $telasig;?>" pattern=".{10}" name="tel"   >
	                    </div>
	                    <div class="input-group input-group-sm">
	                        <span class="input-group-addon" id="sizing-addon3">Folio Orden de Servicio: </span>
	                        <input class="form-control" aria-describedby="sizing-addon4"  name="folio_o"  value="<?php echo $folioOs;?>"  >
	                    </div>
	                    <div class="input-group input-group-sm">
	                        <span class="input-group-addon" id="sizing-addon3">Etapa: </span>
                            <label><?php echo $etapa;?></label>
	                        <!--
	                    ...
	                    <div class="input-group input-group-sm">
	                        ...
	                        <input class="form-control" aria-describedby="sizing-addon4"  name="ps"  value="<?php echo $lps;?>"  >
	                    </div>
	                     <div class="input-group input-group-sm">
 ...
 <?php
                         $sql16="SELECT imagen_n FROM adjunto_venta WHERE folio_venta='$folio_ventas'";
                        // echo "$sql16 <br>";
            $resultado22=$con2->query($sql16);
          while($fila = $resultado22->fetch_assoc()) {
    //echo $fila['imagen_n'];
               $img=$fila['imagen_n'];
               //echo $img;

              echo"<img src='../adjVentas/$img' border='1'  width='500' height='500'>";
            ...
            ?>
						...
						http://localhost/php/validacion/modificarsinvaldiar.php?area=TOLUCA&nombre=LILIANA&apaternov=ROSALES&amaternov=ROQUES&direccion=MORELOS+Y+PAVON+&terminal=221310531&distrito=NO+ME+LO+SE+&datos=ESTA+HERMOSA+LA+CLIENTA+&telefono_1=7227114330&telefono_2=7229099249&telefono_3=7224374063&documentacion=SI&dato_completo=NO&venta_area=NO&cliente_contesto=NO&distrito_asignado=NO&coments_1=&promotor_informo=NO&coments_2=&folio_siac=&valido_horas=NO&detalles=&tienda=&tel_asignado=&folio_os=&etapa=&listo_ps=
