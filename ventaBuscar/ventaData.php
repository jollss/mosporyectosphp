    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            ...
            while($row = $resultado->fetch_assoc())
            {
                ...
                $dato_completo=$row['dato_completo'];
                $venta_area=$row['venta_area'];
                $distrito_asignado=$row['distrito_asignado'];
                $coments_1=$row['coments_1'];
                $promotor_informo=$row['promotor_informo'];
                $coments_2=$row['coments_2'];
                $valido_horas=$row['valido_horas'];
...
<!--==============-->
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="sizing-addon3">Contesto:<?php SiNo($contesto);?></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="sizing-addon3">Datos fueron Completos:<?php SiNo($dato_completo);?></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="sizing-addon3">Venta del Área:<?php SiNo($venta_area);?></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="sizing-addon3">Venta de distrito Asignado:<?php SiNo($distrito_asignado);?></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <label><?php echo $coments_1;?></label>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="sizing-addon3">Promotor Informo detalles:<?php SiNo($promotor_informo);?></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <label><?php echo $coments_2;?></label>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="sizing-addon3">Valido en menos de 24 hrs.:<?php SiNo($valido_horas);?></span>
                    </div>
